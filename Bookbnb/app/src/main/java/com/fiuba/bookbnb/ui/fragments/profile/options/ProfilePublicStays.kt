...
class ProfilePublicStays(context: Context, labelRes: Int, img: Int) : ProfileButtonMenu(context, labelRes, img) {

    override fun loadAction() {
        NavigationManager.moveForward(ProfileMenuFragmentDirections.actionProfileMenuFragmentToNavPublishGraph())
    }
}